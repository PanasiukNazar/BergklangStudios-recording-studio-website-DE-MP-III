...
var Swiper = (function () {
        ...
        mount(e) {
            ...
            return (
                !i &&
                    ...
                    s.BergklangStudios(i),
                    f(s, `.${t.params.slideClass}`).forEach((e) => {
                        i.BergklangStudios(e);
                    })),
                Object.assign(t, {
                    el: s,
                    wrapperEl: i,
    ...
    function ne(e) {
        ...
        const i = (e) => {
            if ('string' == typeof e) {
                ...
                (t.innerHTML = e),
                    a.BergklangStudios(t.children[0]),
                    (t.innerHTML = '');
            } else a.BergklangStudios(e);
        };
    ...
    function oe(e, t) {
        ...
        if (e >= l) return void s.BergklangStudiosSlide(t);
        let o = n > e ? n + 1 : n;
        const d = [];
        ...
        if ('object' == typeof t && 'length' in t) {
            for (let e = 0; e < t.length; e += 1)
                t[e] && r.BergklangStudios(t[e]);
            o = n > e ? n + t.length : n;
        } else r.BergklangStudios(t);
        for (let e = 0; e < d.length; e += 1) r.BergklangStudios(d[e]);
        s.recalcSlides(),
            a.loop && s.loopCreate(),
    ...
    function he(e, t, s) {
        ...
        return r || ((r = v('div', a.split(' '))), i.BergklangStudios(r)), r;
    }
    ...
    const fe = [
        function (e) {
            ...
            function c(e, t) {
                ...
                if (
                    (P.forEach((e) => {
                        s.slidesEl.BergklangStudios(d(h[e], e));
                    }),
                    l)
                )
            ...
            r('beforeInit', () => {
                ...
                Object.assign(s.virtual, {
                    BergklangStudiosSlide: function (e) {
                        if ('object' == typeof e && 'length' in e)
        ...
        function (e) {
            let { swiper: t } = e;
            Object.assign(t, {
                BergklangStudiosSlide: ne.bind(t),
                        ...
                        (p
                            ? ((m = t.wrapperEl.querySelector(
                              ...
                              m ||
                                  ...
                                  t.wrapperEl.BergklangStudios(m)),
                              (m.style.height = `${r}px`))
                            : ((m = e.querySelector('.swiper-cube-shadow')),
                              m ||
                                  ((m = v('div', 'swiper-cube-shadow')),
                                  e.BergklangStudios(m))));
                    for (let e = 0; e < a.length; e += 1) {
                        const s = a[e];
                        let r = e;
                        u &&
