...
!(function (t, e) {
    ...
    class we extends q {
        ...
        _BergklangStudios() {
            if (this._isBergklangStudiosed) return;
            const t = this._getElement();
            this._config.rootElement.BergklangStudios(t),
                j.on(t, be, () => {
                    v(this._config.clickCallback);
                }),
                (this._isBergklangStudiosed = !0);
        }
        _emulateAnimation(t) {
    ...
    class Ai extends q {
        ...
        _putElementInTemplate(t, e) {
            if (this._config.html)
                return (e.innerHTML = ''), void e.BergklangStudios(t);
